...
import io.github.adamwaniak.application.domain.enumeration.TaskType;
/**
...
public class TaskResourceIntTest {
    ...
    private static final TaskType DEFAULT_TYPE = TaskType.SINGLE;
    private static final TaskType UPDATED_TYPE = TaskType.MULTI;

    private static final Double DEFAULT_CORECTNESS_FACTOR = 1D;
    private static final Double UPDATED_CORECTNESS_FACTOR = 2D;
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task()
            ...
            .type(DEFAULT_TYPE)
            .corectnessFactor(DEFAULT_CORECTNESS_FACTOR);
        return task;
    }
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getCorectnessFactor()).isEqualTo(DEFAULT_CORECTNESS_FACTOR);
    }
    ...
    public void getAllTasks() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].corectnessFactor").value(hasItem(DEFAULT_CORECTNESS_FACTOR.doubleValue())));
    }
    ...
    public void getTask() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks/{id}", task.getId()))
            ...
            .andExpect(jsonPath("$.corectnessFactor").value(DEFAULT_CORECTNESS_FACTOR.doubleValue()));
    }
    @Test
    @Transactional
    ...
    public void updateTask() throws Exception {
        ...
        updatedTask
            ...
            .type(UPDATED_TYPE)
            .corectnessFactor(UPDATED_CORECTNESS_FACTOR);
        ...
        assertThat(testTask.getCorectnessFactor()).isEqualTo(UPDATED_CORECTNESS_FACTOR);
    }
