...
import { StudentAnswerComponent, StudentAnswerService } from 'app/features/entities/student-answer';

describe('Component Tests', () => {
    describe('StudentAnswer Management Component', () => {
        let comp: StudentAnswerComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(StudentAnswerComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.studentAnswers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
