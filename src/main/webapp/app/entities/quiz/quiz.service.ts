...
export class QuizService {
    ...
    private convertDateFromClient(quiz: IQuiz): IQuiz {
        const copy: IQuiz = Object.assign({}, quiz, {
            startDate: quiz.startDate != null && quiz.startDate.isValid() ? quiz.startDate.format(DATE_FORMAT) : null,
            endDate: quiz.endDate != null && quiz.endDate.isValid() ? quiz.endDate.format(DATE_FORMAT) : null
        });
        return copy;
    }
